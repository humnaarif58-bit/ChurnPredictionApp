...
st.markdown(
    """
    <h1 style='text-align:center; color:#2E8B57;'>🧑 Employee Churn Prediction App</h1>
    <p style='text-align:center;'>Predict whether an Employee is likely to churn based on input features.</p>
    """,
